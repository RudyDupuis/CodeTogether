...
class TechnologyLevelFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $technologyLevel1->setProfil($this->getReference(ProfileFixtures::PROFILE_1));
        ...
        $technologyLevel2->setProfil($this->getReference(ProfileFixtures::PROFILE_1));
        ...
        $technologyLevel3->setProfil($this->getReference(ProfileFixtures::PROFILE_1));
        ...
        $technologyLevel4->setProfil($this->getReference(ProfileFixtures::PROFILE_2));
