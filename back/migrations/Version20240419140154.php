...
final class Version20240419140154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE profile (id INT NOT NULL, user_relation_id INT NOT NULL, pseudo VARCHAR(255) NOT NULL, linkedin_link VARCHAR(255) DEFAULT NULL, portfolio_link VARCHAR(255) DEFAULT NULL, repository_link VARCHAR(255) DEFAULT NULL, description VARCHAR(1000) DEFAULT NULL, profile_picture VARCHAR(255) DEFAULT NULL, availability VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E6D6B2979B4D58CE ON profile (user_relation_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_PROFILE_PSEUDO ON profile (pseudo)');
        $this->addSql('CREATE TABLE speciality (id INT NOT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE speciality_level (id INT NOT NULL, speciality_id INT NOT NULL, profile_id INT NOT NULL, level VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_484E86183B5A08D7 ON speciality_level (speciality_id)');
        $this->addSql('CREATE INDEX IDX_484E8618275ED078 ON speciality_level (profile_id)');
        $this->addSql('CREATE TABLE technology (id INT NOT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE technology_level (id INT NOT NULL, technology_id INT NOT NULL, profile_id INT NOT NULL, level VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_7A9926774235D463 ON technology_level (technology_id)');
        $this->addSql('CREATE INDEX IDX_7A992677275ED078 ON technology_level (profile_id)');
        ...
        $this->addSql('ALTER TABLE profile ADD CONSTRAINT FK_E6D6B2979B4D58CE FOREIGN KEY (user_relation_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE speciality_level ADD CONSTRAINT FK_484E8618275ED078 FOREIGN KEY (profile_id) REFERENCES profile (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE technology_level ADD CONSTRAINT FK_7A992677275ED078 FOREIGN KEY (profile_id) REFERENCES profile (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile DROP CONSTRAINT FK_E6D6B2979B4D58CE');
